...
#Iteration 3
  ...
  describe '#over_capacity' do
    it 'states if venue is over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
  ...
  # Utilizes 'shift' method to kick out
  # so it will remove the first element,
  # which would be 'Mike'
  describe '#kick_out' do
    it 'kicks patrons out' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
      ...
      venue.add_patron('Cat')
      expect(venue.patrons).to eq ['Mike', 'Megan', 'Bob', 'James', 'Cat']
      expect(venue.kick_out).to eq 'Mike'
    end
  end
end
