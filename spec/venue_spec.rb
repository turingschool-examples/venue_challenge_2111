...
describe Venue do
  ...
  describe '#isnt over capacity' do
    it 'returns a false when venue isnt over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
  ...
  describe '#is over capacity' do
    it 'returns a true when venue is over capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
  ...
  describe '#can kick out patrons until not over capacity' do
